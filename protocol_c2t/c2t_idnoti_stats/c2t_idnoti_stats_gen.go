...
type NotiIDStat [c2t_idnoti.NotiID_Count]int
...
func (es NotiIDStat) String() string {
	...
	for i, v := range es {
		fmt.Fprintf(&buf,
			"%v:%v ",
			c2t_idnoti.NotiID(i), v)
	}
	buf.WriteString("]")
	return buf.String()
}
func (es *NotiIDStat) Inc(e c2t_idnoti.NotiID) {
	es[e] += 1
}
func (es *NotiIDStat) Add(e c2t_idnoti.NotiID, v int) {
	es[e] += v
}
func (es *NotiIDStat) SetIfGt(e c2t_idnoti.NotiID, v int) {
	if es[e] < v {
		es[e] = v
	}
}
func (es NotiIDStat) Get(e c2t_idnoti.NotiID) int {
	return es[e]
}

// Iter return true if iter stop, return false if iter all
// fn return true to stop iter
func (es NotiIDStat) Iter(fn func(i c2t_idnoti.NotiID, v int) bool) bool {
	for i, v := range es {
		if fn(c2t_idnoti.NotiID(i), v) {
			return true
		}
	}
	return false
...
func Index(i int) string {
	return c2t_idnoti.NotiID(i).String()
}
