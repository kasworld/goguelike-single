...
var DemuxRsp2ObjFnMap = [...]func(me interface{}, hd c2t_packet.Header, body interface{}) error{
	...
	c2t_idcmd.PassTurn:          objRecvRspFn_PassTurn,          // PassTurn no action just trigger turn
...
func objRecvRspFn_PassTurn(me interface{}, hd c2t_packet.Header, body interface{}) error {
	robj, ok := body.(*c2t_obj.RspPassTurn_data)
	if !ok {
		return fmt.Errorf("packet mismatch %v", body)
	}
	return fmt.Errorf("Not implemented %v", robj)
