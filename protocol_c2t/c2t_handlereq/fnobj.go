...
var DemuxReq2ObjAPIFnMap = [...]func(
	...
	c2t_idcmd.PassTurn:          Req2ObjAPI_PassTurn,          // PassTurn no action just trigger turn
...
func Req2ObjAPI_PassTurn(
	me interface{}, hd c2t_packet.Header, robj interface{}) (
	c2t_packet.Header, interface{}, error) {
	req, ok := robj.(*c2t_obj.ReqPassTurn_data)
	if !ok {
		return hd, nil, fmt.Errorf("Packet type miss match %v", robj)
	}
	rhd, rsp, err := objAPIFn_ReqPassTurn(me, hd, req)
	return rhd, rsp, err
}

// PassTurn no action just trigger turn
func objAPIFn_ReqPassTurn(
	me interface{}, hd c2t_packet.Header, robj *c2t_obj.ReqPassTurn_data) (
