...
func (tw *Tower) handle_c2tch() {
	for rpk := range tw.c2tCh {
		tw.handleRecvPacket(rpk)
	}
}

func (tw *Tower) handleRecvPacket(rpk *c2t_packet.Packet) {
	switch body := rpk.Body.(type) {
	default:
		g2log.Fatal("invalid packet %v", rpk)
	case *c2t_obj.ReqInvalid_data:
		tw.objAPIFn_ReqInvalid(rpk.Header, body)
	case *c2t_obj.ReqLogin_data:
		tw.objAPIFn_ReqLogin(rpk.Header, body)
	case *c2t_obj.ReqHeartbeat_data:
		tw.objAPIFn_ReqHeartbeat(rpk.Header, body)
	case *c2t_obj.ReqChat_data:
		tw.objAPIFn_ReqChat(rpk.Header, body)
	case *c2t_obj.ReqAchieveInfo_data:
		tw.objAPIFn_ReqAchieveInfo(rpk.Header, body)
	case *c2t_obj.ReqRebirth_data:
		tw.objAPIFn_ReqRebirth(rpk.Header, body)
	case *c2t_obj.ReqMoveFloor_data:
		tw.objAPIFn_ReqMoveFloor(rpk.Header, body)
	case *c2t_obj.ReqAIPlay_data:
		tw.objAPIFn_ReqAIPlay(rpk.Header, body)
	case *c2t_obj.ReqVisitFloorList_data:
		tw.objAPIFn_ReqVisitFloorList(rpk.Header, body)
	case *c2t_obj.ReqPassTurn_data:
		tw.objAPIFn_ReqPassTurn(rpk.Header, body)
	case *c2t_obj.ReqMeditate_data:
		tw.objAPIFn_ReqMeditate(rpk.Header, body)
	case *c2t_obj.ReqKillSelf_data:
		tw.objAPIFn_ReqKillSelf(rpk.Header, body)
	case *c2t_obj.ReqMove_data:
		tw.objAPIFn_ReqMove(rpk.Header, body)
	case *c2t_obj.ReqAttack_data:
		tw.objAPIFn_ReqAttack(rpk.Header, body)
	case *c2t_obj.ReqAttackWide_data:
		tw.objAPIFn_ReqAttackWide(rpk.Header, body)
	case *c2t_obj.ReqAttackLong_data:
		tw.objAPIFn_ReqAttackLong(rpk.Header, body)
	case *c2t_obj.ReqPickup_data:
		tw.objAPIFn_ReqPickup(rpk.Header, body)
	case *c2t_obj.ReqDrop_data:
		tw.objAPIFn_ReqDrop(rpk.Header, body)
	case *c2t_obj.ReqEquip_data:
		tw.objAPIFn_ReqEquip(rpk.Header, body)
	case *c2t_obj.ReqUnEquip_data:
		tw.objAPIFn_ReqUnEquip(rpk.Header, body)
	case *c2t_obj.ReqDrinkPotion_data:
		tw.objAPIFn_ReqDrinkPotion(rpk.Header, body)
	case *c2t_obj.ReqReadScroll_data:
		tw.objAPIFn_ReqReadScroll(rpk.Header, body)
	case *c2t_obj.ReqRecycle_data:
		tw.objAPIFn_ReqRecycle(rpk.Header, body)
	case *c2t_obj.ReqEnterPortal_data:
		tw.objAPIFn_ReqEnterPortal(rpk.Header, body)
	case *c2t_obj.ReqActTeleport_data:
		tw.objAPIFn_ReqActTeleport(rpk.Header, body)
	case *c2t_obj.ReqAdminTowerCmd_data:
		tw.objAPIFn_ReqAdminTowerCmd(rpk.Header, body)
	case *c2t_obj.ReqAdminFloorCmd_data:
		tw.objAPIFn_ReqAdminFloorCmd(rpk.Header, body)
	case *c2t_obj.ReqAdminActiveObjCmd_data:
		tw.objAPIFn_ReqAdminActiveObjCmd(rpk.Header, body)
	case *c2t_obj.ReqAdminFloorMove_data:
		tw.objAPIFn_ReqAdminFloorMove(rpk.Header, body)
	case *c2t_obj.ReqAdminTeleport_data:
		tw.objAPIFn_ReqAdminTeleport(rpk.Header, body)
	case *c2t_obj.ReqAdminAddExp_data:
		tw.objAPIFn_ReqAdminAddExp(rpk.Header, body)
	case *c2t_obj.ReqAdminPotionEffect_data:
		tw.objAPIFn_ReqAdminPotionEffect(rpk.Header, body)
	case *c2t_obj.ReqAdminScrollEffect_data:
		tw.objAPIFn_ReqAdminScrollEffect(rpk.Header, body)
	case *c2t_obj.ReqAdminCondition_data:
		tw.objAPIFn_ReqAdminCondition(rpk.Header, body)
	case *c2t_obj.ReqAdminAddPotion_data:
		tw.objAPIFn_ReqAdminAddPotion(rpk.Header, body)
	case *c2t_obj.ReqAdminAddScroll_data:
		tw.objAPIFn_ReqAdminAddScroll(rpk.Header, body)
	case *c2t_obj.ReqAdminAddMoney_data:
		tw.objAPIFn_ReqAdminAddMoney(rpk.Header, body)
	case *c2t_obj.ReqAdminAddEquip_data:
		tw.objAPIFn_ReqAdminAddEquip(rpk.Header, body)
	case *c2t_obj.ReqAdminForgetFloor_data:
		tw.objAPIFn_ReqAdminForgetFloor(rpk.Header, body)
	case *c2t_obj.ReqAdminFloorMap_data:
		tw.objAPIFn_ReqAdminFloorMap(rpk.Header, body)
	}
}

// Invalid make empty packet error
func (tw *Tower) objAPIFn_ReqInvalid(
	hd c2t_packet.Header, robj *c2t_obj.ReqInvalid_data) (
...
// Login
func (tw *Tower) objAPIFn_ReqLogin(
	hd c2t_packet.Header, robj *c2t_obj.ReqLogin_data) (
...
// Heartbeat
func (tw *Tower) objAPIFn_ReqHeartbeat(
	hd c2t_packet.Header, robj *c2t_obj.ReqHeartbeat_data) (
...
// Chat
func (tw *Tower) objAPIFn_ReqChat(
	hd c2t_packet.Header, robj *c2t_obj.ReqChat_data) (
...
// AchieveInfo
func (tw *Tower) objAPIFn_ReqAchieveInfo(
	hd c2t_packet.Header, robj *c2t_obj.ReqAchieveInfo_data) (
...
// Rebirth
func (tw *Tower) objAPIFn_ReqRebirth(
	hd c2t_packet.Header, robj *c2t_obj.ReqRebirth_data) (
...
// MoveFloor tower cmd
func (tw *Tower) objAPIFn_ReqMoveFloor(
	hd c2t_packet.Header, robj *c2t_obj.ReqMoveFloor_data) (
...
// AIPlay
func (tw *Tower) objAPIFn_ReqAIPlay(
	hd c2t_packet.Header, robj *c2t_obj.ReqAIPlay_data) (
...
func (tw *Tower) objAPIFn_ReqVisitFloorList(
	hd c2t_packet.Header, robj *c2t_obj.ReqVisitFloorList_data) (
...
func (tw *Tower) objAPIFn_ReqPassTurn(
	hd c2t_packet.Header, robj *c2t_obj.ReqPassTurn_data) (
...
func (tw *Tower) objAPIFn_ReqMeditate(
	hd c2t_packet.Header, robj *c2t_obj.ReqMeditate_data) (
...
// KillSelf
func (tw *Tower) objAPIFn_ReqKillSelf(
	hd c2t_packet.Header, robj *c2t_obj.ReqKillSelf_data) (
...
func (tw *Tower) objAPIFn_ReqMove(
	hd c2t_packet.Header, robj *c2t_obj.ReqMove_data) (
...
func (tw *Tower) objAPIFn_ReqAttack(
	hd c2t_packet.Header, robj *c2t_obj.ReqAttack_data) (
...
func (tw *Tower) objAPIFn_ReqAttackWide(
	hd c2t_packet.Header, robj *c2t_obj.ReqAttackWide_data) (
...
func (tw *Tower) objAPIFn_ReqAttackLong(
	hd c2t_packet.Header, robj *c2t_obj.ReqAttackLong_data) (
...
func (tw *Tower) objAPIFn_ReqPickup(
	hd c2t_packet.Header, robj *c2t_obj.ReqPickup_data) (
...
// Drop drop carryobj
func (tw *Tower) objAPIFn_ReqDrop(
	hd c2t_packet.Header, robj *c2t_obj.ReqDrop_data) (
...
func (tw *Tower) objAPIFn_ReqEquip(
	hd c2t_packet.Header, robj *c2t_obj.ReqEquip_data) (
...
func (tw *Tower) objAPIFn_ReqUnEquip(
	hd c2t_packet.Header, robj *c2t_obj.ReqUnEquip_data) (
...
// DrinkPotion
func (tw *Tower) objAPIFn_ReqDrinkPotion(
	hd c2t_packet.Header, robj *c2t_obj.ReqDrinkPotion_data) (
...
// ReadScroll
func (tw *Tower) objAPIFn_ReqReadScroll(
	hd c2t_packet.Header, robj *c2t_obj.ReqReadScroll_data) (
...
func (tw *Tower) objAPIFn_ReqRecycle(
	hd c2t_packet.Header, robj *c2t_obj.ReqRecycle_data) (
...
// EnterPortal
func (tw *Tower) objAPIFn_ReqEnterPortal(
	hd c2t_packet.Header, robj *c2t_obj.ReqEnterPortal_data) (
...
// ActTeleport
func (tw *Tower) objAPIFn_ReqActTeleport(
	hd c2t_packet.Header, robj *c2t_obj.ReqActTeleport_data) (
...
func (tw *Tower) objAPIFn_ReqAdminTowerCmd(
	hd c2t_packet.Header, robj *c2t_obj.ReqAdminTowerCmd_data) (
...
func (tw *Tower) objAPIFn_ReqAdminFloorCmd(
	hd c2t_packet.Header, robj *c2t_obj.ReqAdminFloorCmd_data) (
...
func (tw *Tower) objAPIFn_ReqAdminActiveObjCmd(
	hd c2t_packet.Header, robj *c2t_obj.ReqAdminActiveObjCmd_data) (
...
func (tw *Tower) objAPIFn_ReqAdminFloorMove(
	hd c2t_packet.Header, robj *c2t_obj.ReqAdminFloorMove_data) (
...
func (tw *Tower) objAPIFn_ReqAdminTeleport(
	hd c2t_packet.Header, robj *c2t_obj.ReqAdminTeleport_data) (
...
func (tw *Tower) objAPIFn_ReqAdminAddExp(
	hd c2t_packet.Header, robj *c2t_obj.ReqAdminAddExp_data) (
...
func (tw *Tower) objAPIFn_ReqAdminPotionEffect(
	hd c2t_packet.Header, robj *c2t_obj.ReqAdminPotionEffect_data) (
...
func (tw *Tower) objAPIFn_ReqAdminScrollEffect(
	hd c2t_packet.Header, robj *c2t_obj.ReqAdminScrollEffect_data) (
...
func (tw *Tower) objAPIFn_ReqAdminCondition(
	hd c2t_packet.Header, robj *c2t_obj.ReqAdminCondition_data) (
...
func (tw *Tower) objAPIFn_ReqAdminAddPotion(
	hd c2t_packet.Header, robj *c2t_obj.ReqAdminAddPotion_data) (
...
func (tw *Tower) objAPIFn_ReqAdminAddScroll(
	hd c2t_packet.Header, robj *c2t_obj.ReqAdminAddScroll_data) (
...
func (tw *Tower) objAPIFn_ReqAdminAddMoney(
	hd c2t_packet.Header, robj *c2t_obj.ReqAdminAddMoney_data) (
...
func (tw *Tower) objAPIFn_ReqAdminAddEquip(
	hd c2t_packet.Header, robj *c2t_obj.ReqAdminAddEquip_data) (
...
func (tw *Tower) objAPIFn_ReqAdminForgetFloor(
	hd c2t_packet.Header, robj *c2t_obj.ReqAdminForgetFloor_data) (
...
func (tw *Tower) objAPIFn_ReqAdminFloorMap(
	hd c2t_packet.Header, robj *c2t_obj.ReqAdminFloorMap_data) (
