// Code generated by "genlog.exe -leveldatafile ./g2log/g2log.data -packagename g2log"
...
func (l *LogBase) Monitor(format string, v ...interface{}) {
	...
	s := l.Format2Bytes(1, LL_Monitor, format, v...)
	err := l.Output(LL_Monitor, s)
	if err != nil {
		fmt.Println(err)
	}
}
...
func (l *LogBase) TraceClient(format string, v ...interface{}) {
	...
	s := l.Format2Bytes(1, LL_TraceClient, format, v...)
	err := l.Output(LL_TraceClient, s)
	if err != nil {
		fmt.Println(err)
	}
}
...
func Monitor(format string, v ...interface{}) {
	...
	s := GlobalLogger.Format2Bytes(1, LL_Monitor, format, v...)
	err := GlobalLogger.Output(LL_Monitor, s)
	if err != nil {
		fmt.Println(err)
	}
}
...
func TraceClient(format string, v ...interface{}) {
	...
	s := GlobalLogger.Format2Bytes(1, LL_TraceClient, format, v...)
	err := GlobalLogger.Output(LL_TraceClient, s)
	if err != nil {
		fmt.Println(err)
	}
}
