...
func (n *Node) Init(inode NodeI) {

	n.Dispatcher.Initialize()
	n.inode = inode
	n.children = make([]NodeI, 0)
	n.visible = true
	...
	// Subscribe to events
	n.Subscribe(eventtype.OnDescendant, func(evname eventtype.EventType, ev interface{}) {
		if n.parent != nil {
...
// GetNode satisfies the NodeI interface
...
// BoundingBox satisfies the NodeI interface.
...
// Dispose satisfies the NodeI interface.
func (n *Node) Dispose() {}

// Clone clones the Node and satisfies the NodeI interface.
func (n *Node) Clone() NodeI {
...
func (n *Node) FindPath(path string) NodeI {

	// Internal recursive function to find node
	var finder func(inode NodeI, path string) NodeI
	finder = func(inode NodeI, path string) NodeI {
...
func (n *Node) FindLoaderID(id string) NodeI {

	var finder func(parent NodeI, id string) NodeI
	finder = func(parent NodeI, id string) NodeI {
...
func setParent(parent NodeI, child NodeI) {
...
func (n *Node) ChildAt(idx int) NodeI {
...
func (n *Node) ChildIndex(ichild NodeI) int {
...
func (n *Node) IsAncestorOf(desc NodeI) bool {
...
func (n *Node) LowestCommonAncestor(other NodeI) NodeI {
...
// Remove removes the specified NodeI from the list of children.
// Returns true if found or false otherwise.
func (n *Node) Remove(ichild NodeI) bool {
...
func (n *Node) RemoveAt(idx int) NodeI {
