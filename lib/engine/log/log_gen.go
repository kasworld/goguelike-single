// Code generated by "genlog.exe -leveldatafile log.levels -packagename log"
...
func (l *LogBase) Info(format string, v ...interface{}) {
	if !l.GetLevel().IsLevel(LL_Info) {
		return
	}
	s := l.Format2Bytes(1, LL_Info, format, v...)
	err := l.Output(LL_Info, s)
	if err != nil {
		fmt.Println(err)
	}
}
...
func Info(format string, v ...interface{}) {
	if !GlobalLogger.GetLevel().IsLevel(LL_Info) {
		return
	}
	s := GlobalLogger.Format2Bytes(1, LL_Info, format, v...)
	err := GlobalLogger.Output(LL_Info, s)
	if err != nil {
		fmt.Println(err)
	}
}
