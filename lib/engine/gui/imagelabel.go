...
func NewImageLabel(text string) *ImageLabel {
	...
	il.Panel.Subscribe(eventenum.OnResize, func(evname dispatcheri.EventName, ev interface{}) { il.recalc() })

	// Initializes the label
	il.label.initialize(text, StyleDefault().Font)
	il.label.Subscribe(eventenum.OnResize, func(evname dispatcheri.EventName, ev interface{}) { il.recalc() })
